  ...
  public  class AutofacBusinessModule : Module
    {
        ...
        {
            builder.RegisterType<StudentManager>().As<IStudentService>().SingleInstance(); // Karşılığı Startup.cs'de:  services.AddSingleton<IDogService,DogManager>();  services.AddSingleton<IDogDal, EfDogDal>();
